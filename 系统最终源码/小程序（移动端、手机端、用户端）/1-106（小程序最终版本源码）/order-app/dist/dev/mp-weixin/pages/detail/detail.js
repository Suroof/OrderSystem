  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        n: common_vendor.o(animationfinish),
        o: common_vendor.p({
          name: "home",
          size: 40,
          color: _ctx.$u.color["contentColor"]
        }),
        p: common_vendor.o(toHome),
        q: hasCollect.value == "1"
      }, hasCollect.value == "1" ? {
        r: common_vendor.p({
          color: "#F3AF28",
          size: 40,
        ...
        y: common_vendor.o(toCar),
        z: common_vendor.o(addCar),
        A: common_vendor.o(addBuy)
      });
    };
  }
};
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-5ee9087b"], ["__file", "D:/Work/\u70B9\u9910\u7CFB\u7EDF/\u7CFB\u7EDF\u6700\u7EC8\u6E90\u7801/\u5C0F\u7A0B\u5E8F\uFF08\u79FB\u52A8\u7AEF\u3001\u624B\u673A\u7AEF\u3001\u7528\u6237\u7AEF\uFF09/1-106\uFF08\u5C0F\u7A0B\u5E8F\u6700\u7EC8\u7248\u672C\u6E90\u7801\uFF09/order-app/src/pages/detail/detail.vue"]]);
